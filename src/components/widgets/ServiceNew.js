        ...
        <form>
          <div className="form-row align-items-center">
            ...
            <div className="col-auto">
              ...
              <input type="text" className="form-control mb-2" id="inlineFormInputMlLib" placeholder="MlLib" defaultValue="caffe"></input>
            </div>
            <div className="col-auto">
              <label className="sr-only" htmlFor="inlineFormInputRepository">Repository</label>
              <input type="text" className="form-control mb-2" id="inlineFormInputRepository" placeholder="Repository" defaultValue="/opt/eris/data1/alx/deepdetect-js/n20"></input>
            </div>
            <div className="col-auto">
              <label className="sr-only" htmlFor="inlineFormInputData">Data</label>
              <input type="text" className="form-control mb-2" id="inlineFormInputData" placeholder="Data" defaultValue="/opt/eris/data1/alx/deepdetect-js/n20/news20"></input>
            </div>
            <div className="col-auto">
