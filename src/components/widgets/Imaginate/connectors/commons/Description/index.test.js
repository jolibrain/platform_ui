...
test('render category description from regression result with service settings boundingBox display', async () => {
...
test('render category description from regression chain result with service settings boundingBox display', async () => {
